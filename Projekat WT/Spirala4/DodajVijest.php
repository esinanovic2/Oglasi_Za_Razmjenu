...
<section>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<p id="check">
			<label><input type="checkbox" name="omkomentar">Omogući komentare</label>
		</p>
		<p id="dugme">			
	...
	<?php
			...
			&&isset($_REQUEST['url'])&&($_REQUEST['url']!=""))
		{
			...
			$sqlInsert = "INSERT INTO `vijesti` (`naslov`, `oglas`, `url`, `datum`, `korisnik`, `mozekomentar`)
				VALUES ('".$naslov."','".$oglas."','".$url."',NOW(),".$korisnik.",".$mozekomentar.") ";
